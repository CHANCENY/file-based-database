...
namespace Fdb\Engine;

/**
 * This file contains class Engine which will be and can be used to process .fdb file.
 *
 * This file can be exposed to copyright with intention of open source projects or commercial projects.
 *
 */
class Engine
{
     ...
     * Note: It's important to provide path that is outside webroot for enhancing security.
     * @var string This is file where the all database actions will be done.
     */
