...
namespace Fdb\Statement;

use Fdb\Engine\Engine;
use Fdb\Statement\interfaces\TransactionInterface;
use Fdb\Statement\interfaces\TransactionStatementInterface;
...
class Transaction implements TransactionInterface
{
    ...
    public function validate(string $collection_name): bool
    {
        if($this->condition_key && $this->condition_value && $this->operator) {
            ...
            /**@var $select_interface \Fdb\Statement\Select **/
